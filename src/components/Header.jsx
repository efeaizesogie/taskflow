  ...
  return (
    <>
     <header className="w-full h-screen flex flex-col">
      ...
      <div className='w-full xl:w-1/2 flex flex-col justify-center items-start text-left px-5 xl:px-20 py-16 xl:py-0'>
        ...
        <div className='w-full xl:w-1/2 h-64 xl:h-full bg-[url("/hero-img.png")] bg-cover bg-center bg-no-repeat grayscale sepia-[0.2]'>
        </div>
      </div>
